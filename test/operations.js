...
describe('Operations', () => {
  ...
  describe('fromPromise', () => {
    it('should work', function* () {
      const ch = operations.fromPromise(new Promise((resolve) => {
      ...
      assert.deepEqual(
        yield take(
          operations.fromPromise(new Promise((resolve, reject) => {
            setTimeout(() => reject(new Error('Exception from yieldable')), 500);
          }))
        ),
